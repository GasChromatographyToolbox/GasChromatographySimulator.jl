...
begin 
	...
	md"""
	online, Packages, simulation\_example\_input\_gradient\_function.jl, for GasChromatographySimulator v0.4.0
	"""
...
#=
	...
	using CSV, DataFrames,  GasChromatographySimulator, HypertextLiteral, Plots, PlutoUI, UrlDownload
	md"""
	local, Packages, simulation\_example\_input\_gradient\_function.jl, for GasChromatographySimulator v0.4.0
	"""
=#
end
...
begin 	
	if cat_values == ["all categories"]
		...
		@bind sub_values confirm(GasChromatographySimulator.UI_Substance(GasChromatographySimulator.all_solutes(col.sp, dbfilter); default=(1:1, 0.0, 0.0)))
	end 
end
...
julia_version = "1.9.1"
manifest_format = "2.0"
project_hash = "8cea3474aee35def3e817984163f8ab3ca691fa6"
