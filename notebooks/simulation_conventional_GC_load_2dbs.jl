...
begin 
	...
	md"""
	online, Packages, simulation\_conventional\_GC\_load\_2dbs.jl, for GasChromatographySimulator v0.4.0
	"""
...
#=
	...
	using CSV, DataFrames,  GasChromatographySimulator, HypertextLiteral, Plots, PlutoUI, UrlDownload
	md"""
	local, Packages, simulation\_conventional\_GC\_load\_2dbs.jl, for GasChromatographySimulator v0.4.0
	"""
=#
end
...
if typeof(db_file_1) == Nothing
	...
	**Select a 1st database.**
	...
	db_1[!, :No] = collect(1:length(db_1.Name))
	md"""
...
if typeof(db_file_2) == Nothing
	...
	**Select a 2nd database.**
	...
	db_2[!, :No] = collect(1:length(db_2.Name))
	md"""
...
elseif @isdefined db_2
	...
	online_db[!, :No] = collect(1:length(online_db.Name))
